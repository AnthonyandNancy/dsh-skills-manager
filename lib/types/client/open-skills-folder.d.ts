 ...
 */
export declare function canOpenSkillsDirectory(connection: Pick<ConnectionHandle, 'isLoopback'> | undefined, description: {
    canOpenPath?: boolean;
} | undefined, session: SessionPathRemote | undefined): Promise<boolean>;
/**
 ...
 */
export declare function openSkillsDirectory(api: Pick<SkillsManagerApi, 'skillsDirectory'>, connection: unknown, session: SessionPathRemote | undefined): Promise<string>;
//# sourceMappingURL=open-skills-folder.d.ts.map
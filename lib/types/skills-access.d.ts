 ...
 */
import { type SkillsManagerView, type SkillsViewContext } from './skills-view.ts';
...
export declare function createSkillAccess(ctx: SkillsViewContext): Promise<SkillAccess>;

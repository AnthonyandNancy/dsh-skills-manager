 ...
 */
export type ImportResultType = 'new' | 'duplicate' | 'conflict' | 'invalid' | 'skipped';
/** Structured reason why a candidate copy was filtered as a duplicate. */
export type DuplicateReason = 'same-canonical-path' | 'same-external-fingerprint' | 'already-in-dsh';

...
export async function canonicalRealPath(path: string): Promise<string> {
 ...
 */
export async function fingerprintSkillPath(skillPath: string): Promise<string> {
...
export function isDirectoryBundle(skillPath: string): boolean {
...
export async function canonicalSkillIdentity(skillPath: string): Promise<{
